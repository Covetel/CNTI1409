...
=head2 id
  ...
  data_type: bigint
  default_value: SCALAR(0x96fa210)
  is_auto_increment: 1
  is_nullable: 0
...
=head2 iddisposicion
  ...
  data_type: bigint
  default_value: SCALAR(0x96f5df0)
  is_auto_increment: 1
  is_foreign_key: 1
  is_nullable: 0
...
=head2 resultado
  ...
  data_type: boolean
  default_value: SCALAR(0x96fa1b0)
  is_nullable: 0
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:3xkgmIxtVm/4nbQJI1tsTA
